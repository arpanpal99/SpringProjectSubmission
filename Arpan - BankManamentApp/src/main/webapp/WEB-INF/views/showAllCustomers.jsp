...
<div class="operations">
    <a href="addCustomer"><button class="op button button2">Add New Customer</button></a>
    <a href="add5Customers"><button class="op button button2">Add Five Random Customers</button></a>
    <a href="deleteAllCustomers"><button class="op button button3">Delete All Customers</button></a>
</div>
	<div><h2>Customers List</h2></div>
<table id="customers">
		<thead>
			<tr>
				<th>Customer ID</th>
		...
		<tbody>
			<c:forEach items="${customers}" var="customer">
				<tr class="table-success">
					...
					<td><a href="updateCustomer/${customer.custId}"><button class="op button button1">Update</button></a></td>
					<td><a href="deleteCustomer/${customer.custId}"><button class="op button button3">Delete</button></a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
