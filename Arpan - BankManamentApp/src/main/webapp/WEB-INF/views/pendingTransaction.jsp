...
<body>
	...
	<div class="operations">
	  ...
	  <div><h2>Pending Transaction List</h2></div>
		...
		<tbody>
			<c:forEach items="${transactions}" var="transaction">
				<tr>
					...
					<td><a href=approveTransaction/${transaction.txId}><button class="op button button1">Approve</button></a></td>
					<td><a href=rejectTransaction/${transaction.txId}><button class="op button button3">Reject</button></a></td>	
				</tr>
			</c:forEach>
		</tbody>
	</table>
