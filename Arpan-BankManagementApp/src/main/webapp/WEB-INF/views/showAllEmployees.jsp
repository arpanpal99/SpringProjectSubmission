...
<body>
	...
	<div class="operations">
		<a href="addEmployee"><button class="op button button2">Add
				New Employee</button></a> <a href="add4Employees"><button
				class="op button button2">Add Four Random Employees</button></a> <a
			href="deleteAllEmployees"><button class="op button button3">Delete
		...
		<tbody>
			<c:forEach items="${employees}" var="employee">
				<tr>
					...
					<td><a href="updateEmployee/${employee.empId}"><button
								class="op button button1">Update</button></a></td>
					<td><a href="deleteEmployee/${employee.empId}"><button
